  ...
  intro: {
    ...
    holding: {
      ...
      body:
        ...
        "わざわざ外に出て見る価値のあるものには、これから通る道すじも描かれます。1分ごとに矢印が付き、まだ昇っていないものには昇る時刻も出ます。"
    },
    screen: {
      title: "画面にあるもの",
      body: "空のまわりに5つあります。このうち3つが、頭上に何があるかを教えてくれます。",
      count: {
        where: "左上",
        meaning:
      ...
      passes: {
        where: "左下",
        meaning:
          "次に頭上を通る主要な天体と、昇るまでの時間です。タップすると残りと、どちらを向けばよいかが出ます。"
      },
      marker: {
        where: "空の上",
    ...
    controls: {
      title: "あと2つ",
      body: "ひとつは何を描くかを決めるもの、もうひとつは様子がおかしいときのためのものです。",
      filter: {
        where: "右上",
