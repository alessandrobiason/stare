  ...
  intro: {
    ...
    holding: {
      ...
      body:
        ...
        "일부러 나가서 볼 만한 몇 개에는 곧 지나갈 경로도 함께 그려집니다. 1분마다 화살표가 찍히고, 아직 뜨지 않았다면 뜨는 시각도 나옵니다."
    },
    screen: {
      title: "화면에 있는 것들",
      body: "하늘 주위에 다섯 가지가 있습니다. 이 셋은 머리 위에 무엇이 있는지 알려 줍니다.",
      count: {
        where: "왼쪽 위",
        meaning:
      ...
      passes: {
        where: "왼쪽 아래",
        meaning:
          "다음에 머리 위를 지나갈 주요 천체와 떠오르기까지 남은 시간입니다. 탭하면 나머지와 어느 쪽을 봐야 하는지 나옵니다."
      },
      marker: {
        where: "하늘 위",
    ...
    controls: {
      title: "그리고 두 가지 더",
      body: "하나는 무엇을 그릴지 정하고, 다른 하나는 뭔가 이상할 때 보는 것입니다.",
      filter: {
        where: "오른쪽 위",
