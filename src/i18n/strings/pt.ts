...
export const pt: Strings = {
  intro: {
    ...
    passes: {
      title: "Em breve",
      body: "O cartão de baixo mostra o que vai passar sobre você.",
      ...
      open:
        ...
        "dar para ver.",
      footnote: "Se nada estiver para passar, o cartão nem aparece."
    },
    corners: {
      title: "Nos cantos",
  ...
  filter: {
    ...
    subcategories: {
      ...
      IMAGING: "IMAGENS",
      STARLINK: "STARLINK",
      CONSTELLATIONS: "OUTRAS REDES",
      BROADCAST: "TV E DADOS",
      MOBILE: "TELEFONES E IOT"
    }
  },
  card: {
  ...
  catalog: {
    soon:
      "Procure qualquer objeto do catálogo, esteja ele sobre você agora ou não. Ainda não está pronto."
  },
  language: {
    title: "Idioma",
